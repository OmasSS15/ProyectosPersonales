                    ...
                    <div class="card-header text-white py-3">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-auto d-flex gap-2 me-3">
                                <a class="btn bg-btn rounded-start-pill shadow-sm d-flex align-items-center" href="<?php echo base_url('finanza/upload'); ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center gap-1">
                                                    ...
                                                    <?php endif; ?>
                                                    <a class="btn btn-primary" href="<?= base_url('finanza/show/' . $file->id); ?>">
                                                        <i class='bx bxs-show'></i>
                                                    </a>
                                                    <?php if($file->iduser == $this->session->userdata('user_id')): ?>
                                                        <a class="btn btn-warning" href="<?= base_url('finanza/edit/' . $file->id); ?>">
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer d-flex justify-content-center gap-2">
                                                                            ...
                                                                            <a href="<?= base_url('finanza/delete/' . $file->id); ?>" class="btn btn-modal d-flex align-items-center">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" method="GET" action="<?php echo base_url('finanza') ?>">
                        <div class="col-md-6">
                        ...
                        <div class="modal-footer">
                            <a href="<?php echo base_url('finanza') ?>" class="btn btn btn-outline-modal d-flex align-items-center">

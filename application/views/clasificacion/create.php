...
<div>
    ...
    <div class="container my-4">
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('clasificacion/store'); ?>" method="post" enctype="multipart/form-data" class="row g-3">
                    <div class="col-md-12">
                        <label for="clasificacion" class="form-label">Clasificación</label>
                        <input type="text" class="form-control" id="clasificacion" name="clasificacion" placeholder="Ingresa un nombre..." required>
                    </div>

                    <div class="col-12">
                        <button type="submit" class="btn btn-modal d-flex align-items-center ms-auto">
                            <i class='bx bxs-send fs-5 me-1'></i> Añadir Clasificación
                        </button>
                    </div>
                </form>
            </div>

    ...
    <div class="container my-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url('rh'); ?>">Recursos Humanos</a></li>
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('rh/update/') . $file->id; ?>" method="post" enctype="multipart/form-data" class="row g-3">
                    <div class="col-md-6">

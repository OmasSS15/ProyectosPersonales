                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto ms-3">
                                <h3 class="mb-0 d-flex align-items-center">
                                    <i class='bx bxs-group fs-1 me-1'></i>
                                    <?php echo $title; ?>
                                </h3>
                            </div>
                            <div class="col-auto d-flex gap-2 me-3">
                                <a class="btn bg-btn rounded-start-pill shadow-sm d-flex align-items-center" href="<?php echo base_url('rh/upload'); ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center gap-1">
                                                    ...
                                                    <?php endif; ?>
                                                    <a class="btn btn-primary" href="<?= base_url('rh/show/' . $file->id); ?>">
                                                        <i class='bx bxs-show'></i>
                                                    </a>
                                                    <?php if($file->iduser == $this->session->userdata('user_id')): ?>
                                                        <a class="btn btn-warning" href="<?= base_url('rh/edit/' . $file->id); ?>">
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer d-flex justify-content-center gap-2">
                                                                            ...
                                                                            <a href="<?= base_url('rh/delete/' . $file->id); ?>" class="btn btn-modal d-flex align-items-center">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" method="GET" action="<?php echo base_url('rh') ?>">
                        <div class="col-md-6">
                        ...
                        <div class="modal-footer">
                            <a href="<?php echo base_url('rh') ?>" class="btn btn btn-outline-modal d-flex align-items-center">

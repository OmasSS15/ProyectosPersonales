...
<div>
    ...
    <div class="container my-4">
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('sucursales/store'); ?>" method="post" enctype="multipart/form-data" class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="3" placeholder="Escribe una breve descripción si es necesario..." required></textarea>
                    </div>

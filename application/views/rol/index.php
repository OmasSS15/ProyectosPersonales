                ...
                <div class="card shadow-lg">
                    <div class="card-header text-white py-3">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-auto d-flex gap-2 me-3">
                                <a class="btn bg-btn rounded-3 shadow-sm d-flex align-items-center" href="<?php echo base_url('roles/create'); ?>">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatable_roles" class="table table-striped table-hover text-center">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php foreach ($roles as $rol): ?>
                                        <tr>
                                            <th class="text-center" scope="row"><?php echo $rol->id; ?></th>
                                            <td class="text-center"><?php echo $rol->rol; ?></td>
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center gap-1">
                                                    <a class="btn btn-warning" href="<?= base_url('roles/edit/' . $rol->id); ?>">
                                                        <i class='bx bxs-edit'></i>
                                                    </a>
                                                    <a class="btn btn-danger"  data-bs-toggle="modal" data-bs-target="#modal_delete_<?= $rol->id; ?>">
                                                        <i class='bx bxs-trash'></i>
                                                    </a>
                                                    <!-- Modal Delete -->
                                                    <div class="modal fade" id="modal_delete_<?= $rol->id; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center py-4 px-3">
                                                                    Esta acción eliminará permanentemente el rol de <strong><?= $rol->rol; ?></strong>. ¿Deseas continuar?
                                                                </div>
                                                                <div class="modal-footer d-flex justify-content-center gap-2">
                                                                    ...
                                                                    <a href="<?= base_url('roles/delete/' . $rol->id); ?>" class="btn btn-modal d-flex align-items-center">

...
<div>
    ...
    <div class="container my-4">
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('roles/update/') . $rol->id; ?>" method="post" enctype="multipart/form-data" class="row g-3">

                    <div class="col-md-12">
                        <label for="rol" class="form-label">Cargo</label>
                        <input type="text" class="form-control" id="rol" name="rol" value="<?php echo $rol->rol; ?>" placeholder="Ingresa un nombre..." required>
                    </div>
